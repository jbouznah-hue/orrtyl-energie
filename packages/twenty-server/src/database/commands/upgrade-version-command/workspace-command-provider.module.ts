...
import { V1_24_UpgradeVersionCommandModule } from 'src/database/commands/upgrade-version-command/1-24/1-24-upgrade-version-command.module';
...
@Module({
  imports: [
    ...
    V1_24_UpgradeVersionCommandModule,
